...
static void print_usage(int exit_code) {
  fprintf(exit_code ? stderr : stdout,
          ...
          "  -S, --seconds1=SECONDS   Short term time window\n"
          "  -W, --watts1=WATTS       Short term power limit\n"
          ...
          "\nRAPL is available on Intel CPUs starting with Sandy Bridge (2011).\n"
          "Configurability varies by system, but the following are informal guidelines.\n"
          "ZONE support:\n"
          "  PACKAGE: all CPUs\n"
          "  CORE: all CPUs, except maybe some Atom CPUs\n"
          "  UNCORE: client CPUs\n"
          "  DRAM: server CPUs\n"
          "  PSYS: Skylake (2015) & newer CPUs\n"
          "CONSTRAINT support:\n"
          "  LONG: all zones\n"

...
if __name__ == "__main__":
    ...
    ATOM_SILVERMONT1 = CPU("0x37", "ATOM_SILVERMONT1", [TBL_6, TBL_7, TBL_8, TBL_9])
    ATOM_SILVERMONT1.print_line()
    ATOM_MERRIFIELD = CPU("0x4A", "ATOM_MERRIFIELD", [TBL_6, TBL_7, TBL_8])
    ATOM_MERRIFIELD.print_line()
    ATOM_SILVERMONT2 = CPU("0x4D", "ATOM_SILVERMONT2", [TBL_6, TBL_7, TBL_10])
    ATOM_SILVERMONT2.print_line()
    ATOM_MOOREFIELD = CPU("0x5A", "ATOM_MOOREFIELD", [TBL_6, TBL_7, TBL_8])
    ...
    ATOM_GEMINI_LAKE = CPU("0x7A", "ATOM_GEMINI_LAKE", [TBL_6, TBL_12, TBL_13])
